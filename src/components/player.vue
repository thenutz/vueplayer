<template>
  ...
  >
    ...
    >
      ...
      <div class="video_wrapper" :id="'video-wrapper-' + videoId">
        <!-- <video
          class="oxiplay-video"
          ...
          <div class="controls_wrapper">
            ...
            <div class="controls_buttons">
              <div class="btns_wrapper">
                <div class="left_btns">
                  <div class="play_pause" @click.stop="overlayClick">
                    <Play
                      v-if="
                        !playerStatus.status || playerStatus.status === 'loaded'
                      "
                    />
                    <Pause v-else />
                  </div>
...
export default {
  ...
  methods: {
    ...
    overlayClick() {
      ...
      } else if (this.playerStatus.status === "playing") {
        this.playerStatus.status = "paused";
      } else if (this.playerStatus.status === "paused") {
        this.playerStatus.status = "playing";
      }
    }
    /* makeHash(str, seed = 0) {
